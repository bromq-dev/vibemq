...
impl Session {
    pub fn new(
        ...
        Self {
            ...
            // Start empty, grow on demand
            subscriptions: AHashMap::new(),
            inflight_outgoing: AHashMap::new(),
            inflight_incoming: AHashMap::new(),
            next_packet_id: 1,
            ...
            client_topic_aliases: AHashMap::new(),
            server_topic_aliases: AHashMap::new(),
            next_server_alias: 1,
